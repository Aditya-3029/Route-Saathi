...
string getPasswordunused(const string& prompt = "Enter password: ") {
    cout << prompt;
    string password;
    char ch;
...
void displayRouteSaathiArt() {
    cout << "================================================================================================" << endl;
    typewriterEffect("  _____    ____            _____     _____                     _____  _______  _    _  _____ |");
    typewriterEffect("|  __ \\ / __ \\   /\\   |  __ \\   / ____|  /\\        /\\   |  __ \\__   __| |  | |_   _|");
    typewriterEffect("| |__) | |  | | /  \\  | |  | | | (___   /  \\      /  \\  | |__) | | |  | |__| | | |  ");
    typewriterEffect("|  _  /| |  | |/ /\\ \\ | |  | |  \\___ \\ / /\\ \\    / /\\ \\ |  _  /  | |  |  __  | | | ");
    typewriterEffect("| | \\ \\| |__| / ____ \\| |__| |  ____) / ____ \\  / ____ \\| | \\ \\  | |  | |  | |_| |_");
    typewriterEffect("|_|  \\_\\____/_/    \\_\\_____/  |_____/_/    \\_\\/_/    \\_\\_|  \\_\\ |_|  |_|  |_|_____|");
    cout << "=====================================================================================================" << endl;
}
...
void shortest_moneysaver() {
    ...
    {
        cout << "No Path Possible between Given Set of Source Destination Combinations" << endl;
    }
    else 
    {
...
void minimumInterchange(){
    ...
    if (interchanges[v]==INT_MAX)
    {
        cout<<"NO Path Found Between Given Set of Stations"<<endl;
    }
    else
    {
...
void minimumTime(){
    ...
    {
    cout << "Your least required Time  is: " << distance[v] << " mins" "\nPath: ";
    printPath(v, previous);
    }
}
void newstation(){
...
void showMetroMap(const vector<vector<edgemet>>& graphm) {
    ...
    for (size_t i = 0; i < graphm.size(); ++i) {
        if (!graphm[i].empty()) {
